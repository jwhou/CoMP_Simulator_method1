...
%             end
            ...
            while 1
                ...
                if scheme == 3
                    NewEvents = action_CoMP_method2(Event_list(min_index),PHY_CH_module,Nsubcarrier,channel_model,Bandwidth,Thermal_noise,tx_ant_gain,reflection_times,wall_mix,wall_index,HOV,room_range,AI);
                else
